...
public class AddressBookController {
    ...
    public Result<List<AddressBook>> list() {
        ...
        List<AddressBook> list = userAddressBookService.list(addressBook);
...
//        userAddressBookService.save(addressBook);
    ...
    public Result<AddressBook> getById(@PathVariable Long id) {
        AddressBook addressBook = userAddressBookService.getById(id);
    ...
    public Result setDefault(@RequestBody AddressBook addressBook) {
        userAddressBookService.setDefault(addressBook);
        return Result.success();
    }
