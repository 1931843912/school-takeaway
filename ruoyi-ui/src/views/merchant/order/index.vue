  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="地址id" prop="addressBookId">
        <el-input
          v-model="queryParams.addressBookId"
          placeholder="请输入地址id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="预计送达时间" prop="estimatedDeliveryTime">
        <el-date-picker clearable
          v-model="queryParams.estimatedDeliveryTime"
          type="date"
          value-format="yyyy-MM-dd"
      ...
      <el-form-item label="打包费" prop="packAmount">
        <el-input
          v-model="queryParams.packAmount"
          placeholder="请输入打包费"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="餐具数量" prop="tablewareNumber">
        <el-input
          v-model="queryParams.tablewareNumber"
          placeholder="请输入餐具数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="ordersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单状态 1待付款 2待接单 3已接单 4派送中 5已完成 6已取消 7退款" align="center" prop="status" />
      ...
      <el-table-column label="支付方式 1微信,2支付宝" align="center" prop="payMethod" />
      <el-table-column label="支付状态 0未支付 1已支付 2退款" align="center" prop="payStatus" />
      ...
      <el-table-column label="配送状态  1立即送出  0选择具体时间" align="center" prop="deliveryStatus" />
...
<script>
import { listOrders, getOrders, delOrders, addOrders, updateOrders } from "@/api/merchant/orders/index";
