<template>
      ...
      <el-row :gutter="10" class="mb8">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['system:setmeal:edit']"
          >修改</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['system:setmeal:remove']"
          >删除</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['system:setmeal:export']"
          >导出</el-button>
        </el-col>
  ...
  <script>
  import { listSetmeal, getSetmeal, delSetmeal, addSetmeal, updateSetmeal } from "@/api/merchant/setmeal/index";
  ...
  export default {
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('system/setmeal/export', {
          ...this.queryParams
