...
import com.ruoyi.user.entity.dto.*;
import com.ruoyi.user.entity.exception.AddressBookBusinessException;
import com.ruoyi.user.entity.exception.OrderBusinessException;
import com.ruoyi.user.entity.exception.ShoppingCartBusinessException;
import com.ruoyi.user.entity.po.*;
import com.ruoyi.user.entity.vo.OrderPaymentVO;
import com.ruoyi.user.entity.vo.OrderStatisticsVO;
...
import com.ruoyi.user.utils.WeChatPayUtil;
import com.ruoyi.user.websocket.WebSocketServer;
...
public class UserOrderServiceImpl implements UserOrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        for (ShoppingCart cart : shoppingCartList) {
            ...
            myOrderDetailList.add(orderDetail);
        }

        orderDetailMapper.insertBatch(myOrderDetailList);
...
//        vo.setPackageStr(jsonObject.getString("package"));
        OrderPaymentVO vo = new OrderPaymentVO("支付成功","200","5000","1","200");
        return vo;
    }
