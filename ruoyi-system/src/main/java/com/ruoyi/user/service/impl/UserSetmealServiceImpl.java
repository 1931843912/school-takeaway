...
import com.ruoyi.user.entity.dto.SetmealDTO;
import com.ruoyi.user.entity.dto.SetmealPageQueryDTO;
import com.ruoyi.user.entity.exception.DeletionNotAllowedException;
import com.ruoyi.user.entity.exception.SetmealEnableFailedException;
import com.ruoyi.user.entity.po.Dish;
import com.ruoyi.user.entity.po.Setmeal;
import com.ruoyi.user.entity.po.SetmealDish;
...
public class UserSetmealServiceImpl implements UserSetmealService {
    ...
    public void saveWithDish(SetmealDTO setmealDTO) {
        ...
        //向套餐表插入数据
        userSetmealMapper.insert(setmeal);
        ...
        //保存套餐和菜品的关联关系
        userSetmealDishMapper.insertBatch(setmealDishes);
    }
    ...
    public PageResult pageQuery(SetmealPageQueryDTO setmealPageQueryDTO) {
        ...
        Page<SetmealVO> page = userSetmealMapper.pageQuery(setmealPageQueryDTO);
    ...
    public void deleteBatch(List<Long> ids) {
        ids.forEach(id -> {
            Setmeal setmeal = userSetmealMapper.getById(id);
        ...
        ids.forEach(setmealId -> {
            //删除套餐表中的数据
            userSetmealMapper.deleteById(setmealId);
            //删除套餐菜品关系表中的数据
            userSetmealDishMapper.deleteBySetmealId(setmealId);
        });
    }
    ...
    public SetmealVO getByIdWithDish(Long id) {
        SetmealVO setmealVO = userSetmealMapper.getByIdWithDish(id);
        return setmealVO;
    }
    ...
    public void startOrStop(Integer status, Long id) {
        ...
        if (status == StatusConstant.ENABLE) {
            ...
            List<Dish> dishList = userDishMapper.getBySetmealId(id);
